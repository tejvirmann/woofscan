...
model.add(Dense(2))#used to be 1, now 2
model.add(Activation('softmax')) #used to be sigmoid, now, softmax

# done defining the model 

model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy']) #used to be 'binary_crossentropy'
...
model.fit(X, y_train, batch_size = 500, epochs = 1)
